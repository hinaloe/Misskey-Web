...
window.addEventListener('load', function() {
	...
	var shareFormUrl = 'https://share.misskey.cf/?title=' + document.title + '&url=' + location.href;
	...
	[].forEach.call(document.getElementsByClassName('misskey-share'), function(button) {
		...
		count.setAttribute('href', 'https://search.misskey.cf/?q=' + location.href);
		...
		ajax.open('POST','https://api.misskey.cf/share/count?url=' + location.href, true);
